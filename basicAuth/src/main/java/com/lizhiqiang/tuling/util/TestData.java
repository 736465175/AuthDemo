package com.lizhiqiang.tuling.util;

import com.lizhiqiang.tuling.bean.ResourceBean;
import com.lizhiqiang.tuling.bean.RoleBean;
...
public class TestData {
    ...
    public UserBean queryUser(UserBean loginUser) {
        List<UserBean> allUser = this.getAllUser();
        List<UserBean> userBeans = allUser.stream().filter(userBean ->
                userBean.getUserName().equals(loginUser.getUserName()) &&
                        userBean.getUserPass().equals(loginUser.getUserPass())
